...
@section('title')
    İş Birliği Yaptığımız Kurumlara Verilen Eğitimler
@endsection
                    ...
                    <div class="breadcrumbs-inner">
                        <div class="container">
                            <div class="breadcrumbs-text">
                                <h1 class="breadcrumbs-title">İş Birliği Yaptığımız Kurumlara Verilen Eğitimler</h1>
                                <div class="back-nav">
                                    <ul>
                                        <li><a href="{{route('home.index')}}">Anasayfa</a></li>
                                        <li> İş Birliği Yaptığımız Kurumlara Verilen Eğitimler</li>
                                    </ul>
                                </div>
                            </div>
                        </div>
            ...
            <div class="instructors___page pt---120 pb---140">
                <div class="container pb---60">
                    <div class="row">
                        ...
                        {!! $data->kurumlar ?? 'Değer Girilmemiş' !!}
                    </div>
                </div>
            </div>
        </div>

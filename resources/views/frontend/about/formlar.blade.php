                    ...
                    <div class="breadcrumbs-inner">
                        <div class="container">
                            <div class="breadcrumbs-text">
                                <h1 class="breadcrumbs-title">Formlar</h1>
                                <div class="back-nav">
                                    <ul>
                    ...
                    <div class="row align-items-center back-vertical-middle shorting__course3 mb-50">
                        <div class="col-md-6">
                            <div class="all__icons">
                                <div class="result-count">Aşağıdaki bağlantılardan tüm formlara kolayca ulaşabilirsiniz.</div>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                            ...
                            <div class="event__card">
                                <div class="event__card--content">
                                    <div class="event__card--content-area">
                                        ...
                                        <a class="event__card--link mt-3" href="{{asset('formlar/'.$datas->file)}}" target="_blank"> İndir <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-arrow-right"><line x1="5" y1="12" x2="19" y2="12"></line><polyline points="12 5 19 12 12 19"></polyline></svg></a>
                                    </div>
                                </div>
                            </div>
                        </div>

                            ...
                            <table id="alternative-pagination" class="table nowrap dt-responsive align-middle table-hover table-bordered" style="width:100%">
                                ...
                                @foreach($data as $datas)
                                    <tr>
                                        ...
                                        <td style="width: 5%!important;"><input class="switchStatus" data-id={{ $datas->id }} type="checkbox" {{$datas->status == 0 ? '' : 'checked' }} data-toggle="toggle" data-on="Aktif" data-off="Onayla" data-onstyle="success" data-offstyle="danger"></td>
    ...
    <script>
        ...
        $(function (){
            $('.switchStatus').change(function (){
                ...
                $.get("{{ route('kesin-kayit-basvurulari.switch') }}", {id: id, status: status}, function (data, status){
                    if (status === 'success') {
                        // Elemanı sayfadan kaldır
                        $(this).closest('tr').remove(); // Eğer eleman bir tablo satırında ise
                        // Veya
                        // $(this).remove(); // Eğer eleman doğrudan checkbox ise
                    }
                }.bind(this)); // `this`'i `$.get` callback'ine bağlamak için
            });
        });
